"""
Rules for RNA-seq QC analysis for single-end data
Uses qualimap rnaseq without paired-end option
"""
import os

# Rule for running qualimap rnaseq on single-end data
rule qualimap_rnaseq_single:
    input:
        bam = get_picard_bam,
    ...
    shell:
        ...
        # Run qualimap rnaseq without paired-end option
        ...
        echo "Qualimap rnaseq (single-end) completed successfully" >> {log.stderr}
        """