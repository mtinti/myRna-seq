...
The workflow powers large-scale studies such as the [VSG expression meta-analysis](https://vsgs-web-server.pages.dev/) where we reanalyzed 454 RNA-seq runs (168 single-end, 280 paired-end, and 6 nanopore datasets) drawn from 31 publications, spanning 35 experimental factors across 78 experiments.
